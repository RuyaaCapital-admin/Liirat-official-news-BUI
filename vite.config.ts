          ...
          server.middlewares.use((req, res, next) => {
            ...
            if (req.url?.startsWith("/api")) {
              ...
              console.log("🎯 Available routes:", [
                "/api/ping", "/api/demo", "/api/chat", "/api/ai-chat",
                "/api/market-data", "/api/news-trading", "/api/chart-indicator",
                "/api/technical-analysis", "/api/economic-events", "/api/news",
                "/api/marketaux-news", "/api/price-alert"
              ]);
