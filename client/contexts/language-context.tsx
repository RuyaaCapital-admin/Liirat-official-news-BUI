...
const translations = {
  ...
  en: {
    ...
    "hero.description":
      "Liirat Financial News Platform - Live economic calendar, instant alerts, and advanced analysis for all global markets",
    ...
    "calendar.description":
      "Follow the most important economic events and financial indicators in real-time with advanced filtering capabilities",
    ...
    "about.description":
      "Your trusted platform for financial news and economic analysis",
    ...
    "about.sources.desc":
      "From central banks and official financial institutions",
    ...
    "ai.description":
      "AI-powered analysis of economic events and their market impact",
