    ...
    if (lang === "ar") {
      return [
        ...
        },
        {
          id: "ai-analysis",
          target:
            'button:contains("تحليل الذكاء الاصطناعي"), [data-loc*="ai-event"]',
          title: "🤖 التحليل الذكي",
      ...
      return [
        ...
        },
        {
          ...
          title: "🤖 AI Analysis",
          description:
            "Get instant AI-powered analysis for every economic event",
          emoji: "🤖",
          position: "left",
        },
        {
        ...
        },
        {
          ...
          title: "🧭 Navigation",
          description:
            "Use the menu to quickly access all sections of the site",
          emoji: "🧭",
          position: "bottom",
        },
      ];
      ...
      <div className="fixed inset-0 z-[9999] pointer-events-none">
        ...
        <Card
          ...
          style={{
            top: Math.max(
              10,
              Math.min(calloutPosition.top, window.innerHeight - 180),
            ),
            left: Math.max(
              10,
              Math.min(calloutPosition.left, window.innerWidth - 340),
            ),
          }}
        >
