...
export function MacroCalendarTable({ events, className }: MacroCalendarTableProps) {
  return (
      ...
      <table className="w-full border-collapse bg-card rounded-lg overflow-hidden shadow-sm">
        <thead>
          <tr className="bg-muted/50 border-b border-border">
            ...
            <th className="text-center p-4 font-semibold text-foreground">Importance</th>
            <th className="text-center p-4 font-semibold text-foreground">Previous</th>
            <th className="text-center p-4 font-semibold text-foreground">Forecast</th>
            <th className="text-center p-4 font-semibold text-foreground">Actual</th>
          </tr>
        </thead>
        <tbody>
          {events.length === 0 ? (
