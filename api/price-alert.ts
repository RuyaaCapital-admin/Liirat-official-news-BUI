...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (upperSymbol.includes('USD') || upperSymbol.includes('EUR') || upperSymbol.includes('GBP') || 
        upperSymbol.includes('JPY') || upperSymbol.includes('CAD') || upperSymbol.includes('AUD') ||
    ...
    else if (upperSymbol.includes('BTC') || upperSymbol.includes('ETH') || upperSymbol.includes('LTC') ||
             upperSymbol.includes('XRP') || upperSymbol.includes('ADA') || upperSymbol.includes('DOT')) {
